...
using AllocatorR = hpx::compute::host::block_allocator<Real_t, hpx::execution::experimental::block_fork_join_executor>;
using VectorR = hpx::compute::vector<Real_t, AllocatorR>;
using AllocatorI = hpx::compute::host::block_allocator<Int4_t, hpx::execution::experimental::block_fork_join_executor>;
using VectorI = hpx::compute::vector<Int4_t, AllocatorI>;
...
class Domain {
  ...
  private:
   ...
   /* Node-centered */
   VectorR m_x ;  /* coordinates */
   VectorR m_y ;
   VectorR m_z ;

   VectorR m_xd ; /* velocities */
   VectorR m_yd ;
   VectorR m_zd ;

   VectorR m_xdd ; /* accelerations */
   VectorR m_ydd ;
   VectorR m_zdd ;
   ...
   VectorR m_nodalMass ;  /* mass */

   VectorI m_symmX ;  /* symmetry plane nodesets */
   VectorI m_symmY ;
   VectorI m_symmZ ;
   ...
   VectorI  m_nodelist ;     /* elemToNode connectivity */

   VectorI  m_lxim ;  /* element connectivity across each face */
   VectorI  m_lxip ;
   VectorI  m_letam ;
   VectorI  m_letap ;
   VectorI  m_lzetam ;
   ...
   VectorI    m_elemBC ;  /* symmetry/free-surface flags for each elem face */
   ...
   VectorR m_p ;   /* pressure */
   VectorR m_q ;   /* q */
   VectorR m_ql ;  /* linear term for q */
   VectorR m_qq ;  /* quadratic term for q */

   VectorR m_v ;     /* relative volume */
   VectorR m_volo ;  /* reference volume */
   VectorR m_vnew ;  /* new relative volume -- temporary */
   VectorR m_delv ;  /* m_vnew - m_v */
   VectorR m_vdov ;  /* volume derivative over volume */

   VectorR m_arealg ;  /* characteristic length of an element */

   VectorR m_ss ;      /* "sound speed" */

   VectorR m_elemMass ;  /* mass */
